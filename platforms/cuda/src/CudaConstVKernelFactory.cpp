...
#include "CudaConstVKernelFactory.h"
...
KernelImpl* CudaConstVKernelFactory::createKernelImpl(std::string name, const Platform& platform, ContextImpl& context) const {
