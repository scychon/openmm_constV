...
/**
 * Perform the first step of ConstVLangevin integration.
 */

extern "C" __global__ void integrateConstVLangevinPart1(int numAtoms, int paddedNumAtoms, mixed4* __restrict__ velm, const long long* __restrict__ force, mixed4* __restrict__ posDelta,
...
/**
 * Perform the second step of ConstVLangevin integration.
 */

extern "C" __global__ void integrateConstVLangevinPart2(int numAtoms, real4* __restrict__ posq, real4* __restrict__ posqCorrection, const mixed4* __restrict__ posDelta, mixed4* __restrict__ velm, const mixed2* __restrict__ dt) {
...
extern "C" __global__ void selectConstVLangevinStepSize(int numAtoms, int paddedNumAtoms, mixed maxStepSize, mixed errorTol, mixed friction, mixed kT, mixed2* __restrict__ dt,
